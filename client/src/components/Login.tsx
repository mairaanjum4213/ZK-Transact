      ...
      <div className="container mt-5">
        <div className="row pb-5">
          <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            {/* margin added */}
            <p className="mt-2 mb-2 text-secondary" style={{ fontSize: "larger" }}>
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <p className=" mb-2 text-secondary">Forgot Password? <span className="link-wrapper"><Link className="LinkInput link hover-2" to="/recovery">Recover Password</Link></span></p>
              <button type="submit" className="standarButton-1 mt-2">
                Login
              </button>
            </form>
            <p className="mt-2 mb-5 text-secondary">Don't have an account? <span className="link-wrapper"><Link className="LinkInput link hover-2" to="/register">Create One</Link></span></p>
          </div>
          <div className="col-xl-6 col-lg-6 col-md-6 displayNone d-flex justify-content-center align-items-center">
            <img className="RegisterationImage" src={login} alt="Girl Registering Her Account" />
          </div>
        </div>
      </div>
    </>
