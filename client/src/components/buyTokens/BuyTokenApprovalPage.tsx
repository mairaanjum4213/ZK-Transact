...
const BuyTokenApprovalPage: React.FC = () => {
  ...
  const response = "hardcoded";
 

  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100">
      <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
        <h1 className="text-2xl font-bold text-gray-800 mb-4">Buy Token Request Sent</h1>
        <p className="text-gray-600 mb-4">Your buy token request has been sent to the admin for approval.</p>
