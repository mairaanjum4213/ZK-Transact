...
const Profile: React.FC = () => {
  ...
  //set opacity to 0 to hide error and 1 to display error -> animation add ha isma baki conditoin bad ma lga lenga  
  return (
    <>
      <Toaster position='top-center' reverseOrder={false}></Toaster>
      <BreadCrumb parentPageLink="/" ParentPage="Home" pageName={username + "'s Profile"} ChildPage="Edit Profile" imageUrl={profiling} />
