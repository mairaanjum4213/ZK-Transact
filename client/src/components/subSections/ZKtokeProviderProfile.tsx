                    ...
                    <section className="container mt-2 mb-2">
                        <div className="table-responsive container-fluid ">
                            ...
                            <div className=" container d-flex justify-start-center align-items-center   tableInput">
                                <input type="text" style={{ backgroundColor: "transparent" }} disabled value="value of account" />
                                <CopyToClipboard onCopy={handleCopyToClipboardAccount} text={"account number copied"}>
                                    <MdOutlineContentCopy className="text-secondary fs-5 UsernameCopyicon" style={{ display: "inline" }} />
                                </CopyToClipboard>
                            </div>
                            <div className="row pt-1">
