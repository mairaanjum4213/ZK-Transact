  ...
  return (
    <>
     <Toaster position='top-center' reverseOrder={false}></Toaster>
      <div className="container my-11 py-10 rounded-md FormGeneric w-[50%] ">
        ...
        <div className=" w-full  "><br />
          ...
          <ul className="text-left mb-4">
            ...
            <FaCircleDot className="text-sm text-primaryColor mr-2" />
            ...
            <li className="flex items-center my-2 ">
              <FaCircleDot className=" text-primaryColor mr-2 text-sm" />
        ...
        <div className="flex gap-3 flex-col items-center justify-center mt-4 ">
          <button className="block rounded-full w-44 py-2 px-4 bg-blue-600 hover:bg-blue-800 duration-700 text-white" onClick={handleBecomeMerchant}>
            I consent
          </button>
          <button className="block rounded-full w-44 py-2 px-4 bg-blue-600 hover:bg-blue-800 duration-700 text-white ">
            I do not consent
          </button>
        </div>
      </div>
