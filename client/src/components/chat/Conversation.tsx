...
const Conversation: React.FC<ConversationProps> = ({ data, currentUser, online }) => {
  ...
  return (
    <>
      <div className=" flex-row w-100  conversation rounded chatCard">
        <img
        ...
        <div className="card-body">
          ...
          <p
            className="card-text texl-lg "
          >
            <span className={online ? 'text-green-500 tracking-wider' : 'text-red-400 tracking-wider'}>{online ? "Online" : "Offline"}</span>
          </p>
        </div>
      </div>
     <div className="h-2">
